...
class Window(QWidget):
    def __init__(self):
        ...
        self.music_label = QLabel("Select your audio:")
        ...
        #initializing the drop down menu for the user to choose music
        ...
        v_layout.addWidget(self.music_label)
        v_layout.addWidget(self.audio_dropdown) #add audio dropdown menu to vertical layout
        ...
        self.audio_dropdown.currentIndexChanged.connect(self.update_ui)
    ...
    def update_ui(self):
        ...
        #     except IndexError:
        #         self.pic_title.setText("<h2>No Matching Images</h2>")
        mixer.music.load(music_list[self.audio_dropdown.currentText()])
